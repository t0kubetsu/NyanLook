...
import { ApiError, fetchDeviceDetails, fetchDevices, fetchLocationHistory } from "@/lib/api";
...
export default function MapPage() {
  ...
  const loadDevices = useCallback(async () => {
    ...
    try {
      ...
      if (err instanceof ApiError && err.status === 401) { clearToken(); router.push("/login"); }
  ...
  const selectDevice = useCallback(async (deviceId: string) => {
    ...
    if (historyResult.status === "fulfilled") setLocationHistory(historyResult.value);
